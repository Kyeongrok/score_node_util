...
const statsBasketballScheduleUrl = statsUrlFormats.getBasketballScheduleUrl('2017-02-28', '2017-03-31');

const scheduleExporter = string => excelExporter.scheduleExport(string, targetFileName, sheetName);

const statsScheduleFileSave = (url, targetFileName, sheetName) => {
  const scheduleExporter = string => excelExporter.scheduleExport(string, targetFileName, sheetName);
  crawler.parse(url, scheduleExporter);
};
const statsBaseballMlbScheduleUrl = statsUrlFormats.getBaseballMlbScheduleUrl('2017-04-01', '2017-04-30');
const statsHockeyNhlScheduleUrl = statsUrlFormats.getHockeyNhlLiveUrl('2017-04-01', '2017-04-30');
const statsBasketballNbaScheduleUrl = statsUrlFormats.getBasketballScheduleUrl('2017-04-01', '2017-04-30');
...
const nbaScheduleString = fh.getFileContentsString(`${testDataLocation}2017-2018.json`);
